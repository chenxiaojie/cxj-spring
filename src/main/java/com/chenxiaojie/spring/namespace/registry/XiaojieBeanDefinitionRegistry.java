...
public class XiaojieBeanDefinitionRegistry implements ImportBeanDefinitionRegistrar, BeanFactoryAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        if (this.beanFactory == null) {
            logger.warn("It is better to use CraneConfiguration WITHOUT any xml configuration file, injected by @Configuration or Spring Boot purely");
    ...
    private void registerScheduleManager(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        boolean isAnnotated = importingClassMetadata.isAnnotated(XiaojieConfiguration.class.getName());

        if (isAnnotated) {
            Map<String, Object> attributes = importingClassMetadata.getAnnotationAttributes(XiaojieConfiguration.class.getName());
